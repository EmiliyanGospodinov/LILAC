...
register(
    id='HalfCheetah-Hill-v3',
    entry_point='gym.envs.mujoco:HalfCheetahHillEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)

register(
    id='HalfCheetah-HField-v3',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco:HalfCheetahHFieldEnv',
)

register(
    id='HalfCheetah-Wind-v3',
    max_episode_steps=50,
    entry_point='gym.envs.mujoco:HalfCheetahWindEnv',
)

register(
    id='HalfCheetah-Vel-v3',
    max_episode_steps=50,
    entry_point='gym.envs.mujoco:HalfCheetahVelEnv',
)

register(
    id='HalfCheetah-WindVel-v3',
    max_episode_steps=100,
    entry_point='gym.envs.mujoco:HalfCheetahWindVelEnv',
)

register(
    id='Minitaur-GoalVel-v1',
    max_episode_steps=100,
    entry_point='gym.envs.mujoco:MinitaurGoalVelocityEnv',
)

register(
    id='SawyerReachEnv-v1',
